...
--class com.mobvista.data.mvp_mining.exp1.training_data.RunTrainDataGeneration \
./target/hercules-1.0-SNAPSHOT-jar-with-dependencies.jar \
--start_date $start_date \
--end_date $end_date \
--pkg_name_list $pkg_name_list \
>& ./log/mvp_mining/exp1/training_data/trainDataGeneration_"$start_date"_"$end_date".log
