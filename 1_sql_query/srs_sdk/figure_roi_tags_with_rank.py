...
for line in fin:
    ...
    algo_price = '0'
    try:
        dtm,ad_type,platform,is_hb,ranker,package_name,traffic_package,recall_rank,cnrr_rank = arr[0].split('\t')
    ...
    key = [dtm, ad_type, platform, is_hb, ranker, tags, traffic_tags, recall_rank, cnrr_rank]
    key_s = '\t'.join(key)
...
fout.write('dtm\tad_type\tplatform\tis_hb\tranker\tad_tags\ttraffic_tags\trecall_rank\tcnrr_rank\timp\tins\trev\tcost\treq\talgo_price\tcr_ivr\n')
